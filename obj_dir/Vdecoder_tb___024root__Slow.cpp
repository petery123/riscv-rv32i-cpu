...
Vdecoder_tb___024root::Vdecoder_tb___024root(Vdecoder_tb__Syms* symsp, const char* namep)
...
void Vdecoder_tb___024root___configure_coverage(Vdecoder_tb___024root* vlSelf, bool first);

void Vdecoder_tb___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vdecoder_tb___024root___configure_coverage(this, first);
}
...
// Coverage
void Vdecoder_tb___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
