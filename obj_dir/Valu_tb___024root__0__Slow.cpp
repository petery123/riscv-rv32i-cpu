...
VL_ATTR_COLD void Valu_tb___024root___ctor_var_reset(Valu_tb___024root* vlSelf) {
    ...
    vlSelf->alu_tb__DOT__a = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2055397146921648909ull);
    vlSelf->alu_tb__DOT__b = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 600796422599309602ull);
    vlSelf->alu_tb__DOT__result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 894903665327409720ull);
    vlSelf->alu_tb__DOT__alu_op = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 1964325926924979334ull);
...
VL_ATTR_COLD void Valu_tb___024root___configure_coverage(Valu_tb___024root* vlSelf, bool first) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Valu_tb___024root___configure_coverage\n"); );
    Valu_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
