...
class alignas(VL_CACHE_LINE_BYTES) Vregister_file_tb VL_NOT_FINAL : public VerilatedModel {
    friend class Vregister_file_tb__Syms;
  private:
  ...
  public:
    ...
    Vregister_file_tb_register_file_tb* const __PVT__register_file_tb;
    Vregister_file_tb_std* const __PVT__std;
    Vregister_file_tb___024unit* const __PVT____024unit;
    Vregister_file_tb_register_file_tb__03a__03acg__Vclpkg* const register_file_tb__03a__03acg__Vclpkg;
    Vregister_file_tb_std__03a__03asemaphore__Vclpkg* const std__03a__03asemaphore__Vclpkg;
    Vregister_file_tb_std__03a__03aprocess__Vclpkg* const std__03a__03aprocess__Vclpkg;
    Vregister_file_tb___024unit__03a__03aregister_file_transaction__Vclpkg* const __024unit__03a__03aregister_file_transaction__Vclpkg;
