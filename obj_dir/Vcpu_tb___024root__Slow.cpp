...
Vcpu_tb___024root::Vcpu_tb___024root(Vcpu_tb__Syms* symsp, const char* namep)
...
void Vcpu_tb___024root___configure_coverage(Vcpu_tb___024root* vlSelf, bool first);

void Vcpu_tb___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vcpu_tb___024root___configure_coverage(this, first);
}
...
// Coverage
void Vcpu_tb___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
