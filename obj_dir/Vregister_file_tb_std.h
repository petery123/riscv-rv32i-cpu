...
#ifndef VERILATED_VREGISTER_FILE_TB_STD_H_
#define VERILATED_VREGISTER_FILE_TB_STD_H_  // guard
...
struct Vregister_file_tb_vl_covergroup_options_t__struct__0 {
    ...
    bool operator==(const Vregister_file_tb_vl_covergroup_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vregister_file_tb_vl_covergroup_options_t__struct__0> : public std::true_type {};
struct Vregister_file_tb_vl_covergroup_type_options_t__struct__0 {
    IData/*31:0*/ __PVT__weight;
    IData/*31:0*/ __PVT__goal;
    std::string __PVT__comment;
    ...
    bool operator==(const Vregister_file_tb_vl_covergroup_type_options_t__struct__0& rhs) const {
...
template <>
struct VlIsCustomStruct<Vregister_file_tb_vl_covergroup_type_options_t__struct__0> : public std::true_type {};

class alignas(VL_CACHE_LINE_BYTES) Vregister_file_tb_std final {
  public:
    ...
    // CONSTRUCTORS
    Vregister_file_tb_std();
    ~Vregister_file_tb_std();
    void ctor(Vregister_file_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vregister_file_tb_std);
