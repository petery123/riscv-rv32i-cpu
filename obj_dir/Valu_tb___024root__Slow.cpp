...
void Valu_tb___024root___configure_coverage(Valu_tb___024root* vlSelf, bool first);

void Valu_tb___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Valu_tb___024root___configure_coverage(this, first);
}
...
// Coverage
void Valu_tb___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
