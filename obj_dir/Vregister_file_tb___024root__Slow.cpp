...
Vregister_file_tb___024root::Vregister_file_tb___024root(Vregister_file_tb__Syms* symsp, const char* namep)
...
void Vregister_file_tb___024root___configure_coverage(Vregister_file_tb___024root* vlSelf, bool first);

void Vregister_file_tb___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vregister_file_tb___024root___configure_coverage(this, first);
}
...
// Coverage
void Vregister_file_tb___024root::__vlCoverInsert(uint32_t* countp, bool enable, bool localCounter, const char* filenamep, int lineno, int column,
