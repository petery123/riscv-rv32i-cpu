...
#ifndef VERILATED_VREGISTER_FILE_TB_REGISTER_FILE_TB__03A__03ACG__VCLPKG_H_
#define VERILATED_VREGISTER_FILE_TB_REGISTER_FILE_TB__03A__03ACG__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vregister_file_tb_register_file_tb__03a__03acg__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vregister_file_tb_register_file_tb__03a__03acg__Vclpkg();
    ~Vregister_file_tb_register_file_tb__03a__03acg__Vclpkg();
    void ctor(Vregister_file_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vregister_file_tb_register_file_tb__03a__03acg__Vclpkg);
...
class Vregister_file_tb_register_file_tb__03a__03acg : public virtual VlClass {
  public:
    ...
    VlCoverpointT<1> __PVT____Vcp_write_en;
    VlCoverpointT<1> __PVT____Vcp_write_addr;
    VlCoverpointT<1> __PVT____Vcp_read_addr1;
    VlCoverpointT<1> __PVT____Vcp_read_addr2;
    VlCoverpointT<1> __PVT____Vcp___Vcoverpoint0;

    // INTERNAL METHODS
    virtual const char* typeName() const { return "register_file_tb::cg"; }
    VlClass* clone() const { return new Vregister_file_tb_register_file_tb__03a__03acg(*this); }
  ...
  public:
    Vregister_file_tb_register_file_tb__03a__03acg() = default;
    void init(Vregister_file_tb__Syms* __restrict vlSymsp);
    ~Vregister_file_tb_register_file_tb__03a__03acg() {}
};
