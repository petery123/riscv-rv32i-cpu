...
#ifndef VERILATED_VREGISTER_FILE_TB_REGISTER_FILE_TB__03A__03ACG_READ_ADDR2__VCLPKG_H_
#define VERILATED_VREGISTER_FILE_TB_REGISTER_FILE_TB__03A__03ACG_READ_ADDR2__VCLPKG_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vregister_file_tb_register_file_tb__03a__03acg_read_addr2__Vclpkg final {
  public:
    ...
    // CONSTRUCTORS
    Vregister_file_tb_register_file_tb__03a__03acg_read_addr2__Vclpkg();
    ~Vregister_file_tb_register_file_tb__03a__03acg_read_addr2__Vclpkg();
    void ctor(Vregister_file_tb__Syms* symsp, const char* namep);
    void dtor();
    VL_UNCOPYABLE(Vregister_file_tb_register_file_tb__03a__03acg_read_addr2__Vclpkg);
...
class Vregister_file_tb_register_file_tb__03a__03acg_read_addr2 : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "register_file_tb::cg_read_addr2"; }
    VlClass* clone() const { return new Vregister_file_tb_register_file_tb__03a__03acg_read_addr2(*this); }
  ...
  public:
    Vregister_file_tb_register_file_tb__03a__03acg_read_addr2() = default;
    void init(Vregister_file_tb__Syms* __restrict vlSymsp);
    ~Vregister_file_tb_register_file_tb__03a__03acg_read_addr2() {}
};
